      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
          ...
          <a href="#/" className="flex items-center gap-2 group/logo interactive-hover">
            <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6 text-neon group-hover/logo:rotate-45 transition-transform duration-500">
          ...
          <ul className="hidden md:flex items-center gap-10">
            {navLinks.map((link, idx) => (
              <li key={idx} className="overflow-hidden h-6 relative group">
                ...
                <a 
                  href={link.href}
                  className="block font-sans text-sm font-medium tracking-wide text-neon absolute top-full left-0 transition-transform duration-300 group-hover:-translate-y-full"
                >
                  {link.label}
                </a>
              </li>
